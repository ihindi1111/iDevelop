...
urlpatterns = [
    ...
    path("get-list/", views.ajax_get_friend_list, name="ajax-get-friend-list"),
    path("accept-friend-request/<int:request_id>/", views.ajax_accept_friend_request, name="ajax-accept-friend-request"),
    path("cancel-friend-request/<int:request_id>/", views.ajax_cancel_friend_request, name="ajax-cancel-friend-request"),
    path("send-friend-request/<int:student_id>/", views.ajax_send_friend_request, name="ajax-send-friend-request"),
    path('remove-friend/<int:student_id>/', views.ajax_remove_friend, name='ajax-remove-friend'),
    path("students/", views.students_list, name="students"),  # Add this line
]
